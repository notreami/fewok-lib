 ...
 */
@Slf4j
public class ReviseProcessTest {
    ...
    static {
        ...
        bTestExecuteContext = ExecuteContext.builder()
                ...
                .then(new BTestActivity(), ExecuteRule.builder().invokeType(InvokeType.ASYNC).timeoutMillis(20).build())
                .revise(new HTestActivity(), ExecuteRule.builder().invokeType(InvokeType.ASYNC).build())
                .revise(new GTestActivity(), ExecuteRule.builder().invokeType(InvokeType.SYNC).build())
